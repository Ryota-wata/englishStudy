...
@section('content')
    <div class="container"><br>
        ...
        <form action="{{ route('sentence.store') }}" method="POST">
            @csrf
            <div class="form-group">
                <label for="japanese_sentence">日本語:</label>
                <input type="text" name="japanese_sentence" id="japanese_sentence" class="form-control" required>
            </div><br>
            <div class="form-group">
                <label for="english_sentence">英語:</label>
                <input type="text" name="english_sentence" id="english_sentence" class="form-control" required>
            </div><br>
